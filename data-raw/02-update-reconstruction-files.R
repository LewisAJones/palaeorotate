...
SETON2012[, 87:196] <- NA
# Save data
saveRDS(SETON2012, "./data-raw/SETON2012.rds", compress = "xz")
...
# Save data
saveRDS(MULLER2016, "./data-raw/MULLER2016.rds", compress = "xz")
...
# Save data
saveRDS(MATTHEWS2016_mantle_ref, "./data-raw/MATTHEWS2016_mantle_ref.rds", compress = "xz")
saveRDS(MATTHEWS2016_pmag_ref, "./data-raw/MATTHEWS2016_pmag_ref.rds", compress = "xz")
